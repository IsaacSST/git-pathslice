...
```sh
git pathslice log docs       # inspect the proposed selection
git pathslice update docs    # build locally
...
```sh
git pathslice continue docs
# Alternatively:
git pathslice skip docs
git pathslice abort docs
```
